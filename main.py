...
def format_link(y, m):
    if m < 10:
        return f"https://www.unian.ua/news/archive/{y}0{m}04"
    elif m >= 10 and m < 13:
        return f"https://www.unian.ua/news/archive/{y}{m}04"
...
database_obj = DataBase("./data.txt")
database_obj.write_in_database(all_textes_news)
print('all_textes_news', all_textes_news)
